...
namespace Labirinto
{
    ...
    public partial class Principal : Form
    {
        ...
        private void btnProfundidade_Click(object sender, EventArgs e)
        {
            ...
            if (grafo != null)
            {
                if (Alternativo.Checked)
                {
                    grafo.ZeraNodes();
                    DrawNodes(grafo.DepthFirstSearch1(nome));
                }
                else
        ...
        private void btnMinimo_Click(object sender, EventArgs e)
        {
            ...
            {
                if (Alternativo.Checked)
                    DrawNodes(grafo.ShortestPath1(nome, sai));
                else
                    DrawNodes(grafo.ShortestPath(nome, sai));
            }
        }

        private void Alternativo_CheckedChanged(object sender, EventArgs e)
        {
